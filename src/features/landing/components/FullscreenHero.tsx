    ...
    return (
        <section className={className ?? "relative isolate min-h-screen w-full overflow-hidden bg-[#0E3BAF] pt-[72px]"}>
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col gap-3 sm:flex-row">
                <button className="h-11 rounded-md bg-yellow-400 px-5 text-sm font-semibold text-blue-950 shadow-sm transition-colors hover:bg-yellow-300">
                    Khám phá khóa học
                </button>
                <button className="h-11 rounded-md bg-white px-5 text-sm font-semibold text-slate-900 shadow-sm transition-colors hover:bg-slate-100">
                    Tư vấn
                </button>
            </div>
