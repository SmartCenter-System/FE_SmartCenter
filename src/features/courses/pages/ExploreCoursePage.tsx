													...
													<div className="space-y-4 p-5">
														...
														<div className="flex items-end justify-between gap-4">
															...
															<button
																...
																className="inline-flex items-center gap-2 rounded-xl bg-indigo-700 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-yellow-400 hover:text-blue-950"
															>
																Xem chi tiết
