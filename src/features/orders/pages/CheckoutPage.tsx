...
export default function CheckoutPage() {
  ...
  // Redirect if already owned
  useEffect(() => {
    if (isAlreadyOwned) {
      toast.info("Bạn đã sở hữu khóa học này. Chuyển đến trang bài học...");
      // Find the first lesson or just go to course detail
      navigate(`/courses/${id}`);
    }
  }, [isAlreadyOwned, id, navigate]);
