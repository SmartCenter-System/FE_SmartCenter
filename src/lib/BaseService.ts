  ...
  return {
    ...
    create:
      ...
      (async (dto: TCreateDto) => {
        return axios.post<TEntity>(endpoint, dto) as unknown as Promise<TEntity>;
      }),
    ...
    update:
      ...
      (async (id: string | number, dto: TUpdateDto) => {
        return axios.put<TEntity>(`${endpoint}/${id}`, dto) as unknown as Promise<TEntity>;
      }),
    ...
    getSelectOptions:
      ...
      (async () => {
        return axios.get<SelectOption[]>(`${endpoint}/select`) as unknown as Promise<SelectOption[]>;
      }),
  };
}
